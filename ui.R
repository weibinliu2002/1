...
shinyUI(navbarPage(
  ...
  ")),
      selectInput(
        "select",
        label = h4("图形种类"),
        choices = list("散点图", "右部图形", "顶部图形")
      ),
      conditionalPanel(
        condition = "input.select == '散点图'",
        ...
        conditionalPanel(
          condition = "input.colour",
          colourInput("color2", label = "散点和置信区间颜色", value =
                        "#EDBB47"),
          colourInput("c2", label = "散点外圈颜色", value =
                        "black"),
          colourInput("c1", label = "直线回归方程和回归直线颜色", value =
                        "#F77423")
        ),
        ...
        conditionalPanel(condition = "input.zbz",
                         fluidRow(
                           column(
                             6,
                             checkboxInput("showXAxis", "横坐标轴", FALSE),
                             conditionalPanel(
                               condition = "input.showXAxis",
                               sliderInput(
                                 "ss1",
                                 label = "横坐标字体大小",
                                 min = 5,
                           ...
                           column(
                             6,
                             checkboxInput("showYAxis", "纵坐标轴", FALSE),
                             conditionalPanel(
                               condition = "input.showYAxis",
                               sliderInput(
                                 "ss2",
                                 label = "纵坐标字体大小",
                                 min = 5,
                               ...
                               colourInput("d3", label = "纵坐标字体颜色", value =
                                             "black"),
                               sliderInput(
                                 "ss4",
                                 label = "纵标题字体大小",
                               ...
                               colourInput("d4", label = "纵标题字体颜色", value =
                                             "black"),
                               selectInput(
                                 "ss6",
                                 label = "纵标题字体样式",
      ...
      conditionalPanel(
        ...
        conditionalPanel(
          condition = "input.rc",
          colourInput("color4", label = "概率密度图颜色", value =
                        "#FFEAB5"),
          colourInput("color5", label = "箱图颜色", value =
                        "#FFE570"),
          colourInput("color11", label = "箱图边框颜色", value =
                        "black"),
          colourInput("color6", label = "点颜色", value =
                        "#a899e5"),
          colourInput("color13", label = "点外圈颜色", value =
                        "black")
        ),
        checkboxInput("conn", "箱图", FALSE) ,
        conditionalPanel(
          condition = "input.conn ",
          sliderInput(
            "rr3",
            label = "箱图宽度",
            min = 0.05,
        ...
        checkboxInput("spott", "数据点", FALSE) ,
        conditionalPanel(
          condition = "input.spott ",
          sliderInput(
            "rr1",
            label = "数据点的分布",
            min = 0.1,
      ...
      conditionalPanel(
        condition = "input.select == '顶部图形'",
        
        checkboxInput("tc", "颜色", FALSE) ,
        conditionalPanel(
          condition = "input.tc",
          colourInput("color7", label = "密度脊线图颜色", value =
                        "#FFCBB5"),
          colourInput("color8", label = "箱图颜色", value =
                        "#FF6E26"),
          colourInput("color10", label = "箱图边框颜色", value =
                        "black"),
          colourInput("color9", label = "点颜色", value =
                        "#FFB8DF"),
          colourInput("color12", label = "点外圈颜色", value =
                        "black")
        ),
        ...
        checkboxInput("spot", "数据点", FALSE) ,
        conditionalPanel(
          condition = "input.spot ",
          sliderInput(
            "tt1",
            label = "数据点的分布",
            min = 0.1,
