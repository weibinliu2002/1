...
shinyUI(navbarPage(
  ...
  ")),
             ...
             conditionalPanel(condition="input.select == '右部图形'",
                          ...
                          conditionalPanel(condition = "input.spott ",      
                                           sliderInput("rr1",label = "数据点的分布",min = 0.1,max = 5,value = 0.5),
                                           
                                           sliderInput("rr4",label = "数据点的大小",min = 1,max = 6,value = 3),
                                           sliderInput("rr5",label = "数据点的透明度",min = 0.1,max = 1,value = 0.5),
                                           sliderInput("rr6",label = "数据点外圈粗细",min = 0,max = 1.6,value = 0.8),
                          selectInput("rr0",label = "数据点的形状",choices = list("圆形"=21,"正方形"=22,"菱形"=23,"正三角形"=24,"倒三角形"=25))),
                          
             ),
             conditionalPanel(condition="input.select == '顶部图形'",
                             
                         checkboxInput("tc", "颜色", FALSE) ,
                              conditionalPanel(condition = "input.tc",    
                                colourInput("color7",label = "密度脊线图颜色",value="#FFCBB5"),
                         ...
                         conditionalPanel(condition = "input.spot ",      
                                sliderInput("tt1",label = "数据点的分布",min = 0.1,max = 5,value = 0.5),
                                
                                sliderInput("tt4",label = "数据点的大小",min = 1,max = 6,value = 3),
                                sliderInput("tt5",label = "数据点的透明度",min = 0.1,max = 1,value = 0.5),
                                sliderInput("tt6",label = "数据点外圈粗细",min = 0,max = 1.6,value = 0.8),
                                selectInput("tt0",label = "数据点的形状",choices = list("圆形"=21,"正方形"=22,"菱形"=23,"正三角形"=24,"倒三角形"=25)),
